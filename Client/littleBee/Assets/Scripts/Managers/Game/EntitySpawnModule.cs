        ...
        Handler.Run((obj) => {
            ...
            switch (creation.Type)
            {
                case EntityType.Bullet:                          
                    ...
                    Components.Common.Transform2D bulletTransform = world.GetComponentByEntityId<Components.Common.Transform2D>(creation.EntityId);
                ...
                case EntityType.Star:
                    ...
                    var starInfo = mapCreateResourceVO.Info as StarObjectInfo;
